...
def plot_training_validation(train_loss, train_acc, val_loss, val_acc, experiment_name, PREFIX):
    ...
    plt.savefig(PREFIX + "logs/" + experiment_name + "/training_loss_" + experiment_name + ".png")
    ...
    plt.savefig(PREFIX + "logs/" + experiment_name + "/training_acc_" + experiment_name + ".png")
